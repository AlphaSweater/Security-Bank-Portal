...
import { FiArrowUpRight, FiArrowDownRight, FiCreditCard, FiDollarSign, FiTrendingUp } from 'react-icons/fi';
...
const accountData = {
  ...
  expenses: 2350.00,
  recentTransactions: [
    { id: 1, name: 'Salary', amount: 4500.00, type: 'income', date: '2025-10-01' },
    { id: 2, name: 'Grocery Store', amount: -156.78, type: 'expense', date: '2025-10-01' },
    { id: 3, name: 'Electric Bill', amount: -89.99, type: 'expense', date: '2025-09-30' },
  ]
};
...
function StatCard({ title, value, change, isPositive, icon: Icon }) {
  return (
    <div className={styles.statCard}>
      ...
      <div className={styles.statValue}>${value.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
      {change !== undefined && (
